...
Implements various regression, classification, clustering, and neural network models
"""
...
class ModelTrainer:
    def __init__(self, data_path):
        """Initialize the model trainer with data loading and preprocessing"""
    ...
    def load_and_preprocess_data(self):
        ...
        X = X.values
        # y is already a numpy array after label encoding, no need for .values
    ...
    def train_regression_models(self):
        ...
        # Simple Linear Regression (using ApplicantIncome to predict LoanAmount)
        print("\n1. Simple Linear Regression...")
        simple_lr = LinearRegression()
        # Use ApplicantIncome (index 5) to predict LoanAmount (index 7)
        X_simple = self.X_train_scaled[:, 5:6]  # ApplicantIncome
        y_simple = self.X_train_scaled[:, 7:8]  # LoanAmount
    ...
    def train_classification_models(self):
        ...
        try:
            # Try new API first (sklearn >= 0.24)
    ...
    def train_neural_networks(self):
        ...
        try:
            ...
            # Try new Keras 3.x API first, fall back to old API
            try:
    ...
    def cross_validation_evaluation(self):
        ...
        # Leave-One-Out Cross-Validation (on smaller subset for speed)
